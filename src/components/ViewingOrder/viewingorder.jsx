    ...
    return (
        <div className='viewing-order'>
            ...
            <ul className='order-ul'>
                ...
                <li>I Am Groot (2022)</li>
                <li>She-Hulk (2022)</li>
                <li>Werewolf By Night (2022)</li>
                <li>Black Panther: Wakanda Forever (2022)</li>
            ...
            <ul className='order-ul'>
                ...
                <li>Loki S2 (2023)</li>
                <li>The Marvels (2023)</li>
                <li>What If...? S2 (2023)</li>
                <li>Echo (2024) </li>
            </ul>
        </div>
    )
